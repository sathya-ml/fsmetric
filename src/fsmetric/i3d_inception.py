"""
File taken from: https://github.com/dlpbc/keras-kinetics-i3d/blob/master/i3d_inception.py
See https://github.com/dlpbc/keras-kinetics-i3d/blob/master/LICENSE for license information.
...
def _obtain_input_shape(input_shape,
    ...
    (Adapted from `keras/applications/imagenet_utils.py`)c
    ...
    # Arguments
        ...
        data_format: image model format to use.
...
def Inception_Inflated3d(include_top=True,
    ...
    TensorFlow and Theano. The model format
    ...
    # Arguments
        ...
        input_shape: optional shape tuple, only to be specified
            ...
            has to be `(NUM_FRAMES, 224, 224, 3)` (with `channels_last` model format)
            or `(NUM_FRAMES, 3, 224, 224)` (with `channels_first` model format).
